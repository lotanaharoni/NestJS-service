...
let CustomerController = class CustomerController {
    ...
    async isCustomer(firstName, lastName) {
        console.log('lotan1', firstName);
        console.log('lotan2', lastName);
        return this.customerService.isCustomer(firstName, lastName);
    }
};
__decorate([
    common_1.Post(),
    swagger_1.ApiCreatedResponse({ description: 'Add customer by firstName and lastName' }),
...
__decorate([
    ...
    swagger_1.ApiDefaultResponse({ description: 'Find customer by firstNmae and lastName' }),
